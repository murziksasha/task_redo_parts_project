...
var changeModalState = function changeModalState(state) {
  var windowForm = document.querySelectorAll('.balcon_icons_img'),
      windnowWidth = document.querySelectorAll('#width'),
      windnowHeight = document.querySelectorAll('#height'),
    ...
    elem.forEach(function (item, i) {
      item.addEventListener(event, function () {
        switch (item.nodeName) {
          case 'SPAN':
            console.log('span');
            state[prop] = i; //записывается номер изображения балконов
  ...
  bindActionToElems('input', windnowHeight, 'height');
  bindActionToElems('input', windnowWidth, 'width');
...
var forms = function forms(state) {
  ...
  var message = {
    loading: 'Loading',
    success: 'Thanks! We are calling you soon',
...
var modals = function modals() {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        windows.forEach(function (item) {
          item.style.display = 'none'; // console.log(item.hasAttribute('data-modal'));
        });
        showModal(modal); // windows.forEach(item => {
        //     showModal(item);
        // });
      });
    });
  ...
  function hiddenCloser(bodyToHide) {
    bodyToHide.style.display = 'none'; //document.body.classList.remove('modal-open');
    // document.body.style.overflow = 'hidden';

    bodyToHide.style.display === 'block' ? document.body.style.overflow = 'hidden' : document.body.style.overflow = ''; // windows.forEach(item => {
  ...
  function showModal(bodyToHide) {
    bodyToHide.style.display = 'block'; //document.body.classList.add('modal-open');
